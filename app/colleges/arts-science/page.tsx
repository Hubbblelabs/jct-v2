                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-medium">Bharathiar University</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="w-2 h-2 bg-accent rounded-full" />
                                    <span className="text-sm font-medium">UG & PG Programs</span>
                                </div>
                            </div>
                        </div>
                        <div className="relative">
                            <div className="aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-br from-secondary to-secondary-dark shadow-xl">
                                <div
