                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-medium">NAAC &apos;A&apos; Grade</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="w-2 h-2 bg-accent rounded-full" />
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-4">
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 rounded-lg bg-accent flex items-center justify-center text-primary-dark">
                                        <TrophyIcon />
                                    </div>
                                    <div>
                                        <div className="text-sm text-neutral-500">Since</div>
                                        <div className="text-xl font-bold text-primary">2008</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="text-center max-w-2xl mx-auto">
                        ...
                        <p className="text-neutral-600 mb-8">
                            Join our community of innovators and begin your path to success.
                        </p>
